...
function create_miami_plot(male_variant_bins, male_unbinned_variants, female_variant_bins, female_unbinned_variants){
    ...
    console.log("male")
    console.log(male_variant_bins)
    console.log(male_unbinned_variants)

    console.log("female")
    console.log(female_variant_bins)
    console.log(female_unbinned_variants)
...
function create_qq_plot(maf_ranges, qq_ci, type = "both") {
