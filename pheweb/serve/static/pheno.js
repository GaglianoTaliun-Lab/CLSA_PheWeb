...
function create_miami_plot(male_variant_bins, male_unbinned_variants, female_variant_bins, female_unbinned_variants){
    ...
    $(function() {
        ...
        var includes_pval0 = _.any(male_unbinned_variants, function(variant) { return variant.pval === 0; });
        ...
        // TODO: if the label touches any circles or labels, skip it?
        var variants_to_label = _.sortBy(_.where(male_unbinned_variants, {peak: true}), _.property('pval'))
            .filter(function(d) { return d.pval < 5e-8; })
            .slice(0,7);

        var genenames = miami_plot.append('g')
            .attr('class', 'genenames')
            .selectAll('text.genenames')
            .data(variants_to_label)
            .enter()
